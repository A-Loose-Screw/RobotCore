  ...
  namespace Timing {
    class RBCTimer {
     public:
       ...
       * @return double 
       */
      static double getDuration_micro(time_stamp first, time_stamp second);
       ...
       * @return double 
       */
      static double getDuration_ms(time_stamp first, time_stamp second);
       ...
       * @return double 
       */
      static double getDuration_s(time_stamp first, time_stamp second);
